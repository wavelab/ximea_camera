...
*/
	ros::Publisher test_publisher = pnh.advertise<std_msgs::UInt8>(string("test"), 1);
...
*/
  ...
  ros::Rate inner_loop_rate(40.0*desired_frame_rate);
...
*/
    frame_period = (int)(1000.0/desired_frame_rate + 0.5);
    ...
    {	
      ...
      msecs = 0;
      nsecs /= 1000000;
      msecs += nsecs;  //milli seconds max framerate = 1000
         
      if (!(msecs % frame_period))
      {
